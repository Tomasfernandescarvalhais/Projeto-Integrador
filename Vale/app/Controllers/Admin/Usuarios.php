...
class Usuarios extends BaseController {
    ...
    public function cadastrar() {
        ...
        if ($this->request->getMethod() === 'post') {
            ...
            if ($this->usuarioModel->protect(false)->save($usuario)) {
                ...
                return redirect()->back()->with('errors_model', $this->usuarioModel->errors())->with('atencao', 'Verifique os erros abaixo')->withInput();
            }
        } else {
    ...
    public function atualizar($id = null) {
        ...
        if ($this->request->getMethod() === 'post') {
            ...
            if (!$usuario->hasChanged()) {
                return redirect()->back()->with('info', 'Não ouve alterações no Usuário');
            }
    ...
    public function excluir($id = null) {
        ...
        if ($usuario->is_admin) {
            return redirect()->back()->with('info', 'Não e possivel excluir um usuário <b>Administrador</b>');
        }
